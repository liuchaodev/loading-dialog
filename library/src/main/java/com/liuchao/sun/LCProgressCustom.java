...
import com.liuchao.sun.views.CustomView;

public final class LCProgressCustom extends LCProgressBaseDialog {
    ...
    private LCProgressCustom(Builder builder) {
    ...
    public void show() {
        if (mBuilder.mType != NO_TYPE) {
            ...
            Log.d(LCProgressCustom.class.toString(), "you must assign the image source in Builder");
        }
    }
    ...
    public static class Builder {
        ...
        public LCProgressCustom build() {
            return new LCProgressCustom(this);
        }
