...
import com.liuchao.sun.views.FlowerView;

import java.util.Timer;
import java.util.TimerTask;


public class LCProgressFlower extends LCProgressBaseDialog {
    ...
    private LCProgressFlower(Builder builder) {
    ...
    public void show() {
        ...
        mTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if (mBuilder.mDirection == LCProgressConstant.DIRECT_CLOCKWISE) {
    ...
    public static class Builder {
        ...
        private int mDirection = LCProgressConstant.DIRECT_CLOCKWISE;
        ...
        public LCProgressFlower build() {
            return new LCProgressFlower(this);
        }
