...
import com.liuchao.sun.views.PieView;
...
public class LCProgressPie extends LCProgressBaseDialog {
    ...
    public void show() {
        ...
        super.show();
        if (mBuilder.mUpdateType == LCProgressConstant.PIE_AUTO_UPDATE) {
    ...
    public void setPiePercentage(float percentage) {
        if (mBuilder.mUpdateType == LCProgressConstant.PIE_MANUAL_UPDATE && mPieView != null) {
    ...
    public static class Builder {
        ...
        private int mUpdateType = LCProgressConstant.PIE_AUTO_UPDATE;
